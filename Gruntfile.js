...
module.exports = function(grunt) {
    ...
    tasks.ignorefiles = function() {
      ...
      var ignorePatterns = ['# Generated by "grunt ignorefiles"', '*/**/yui/src/*/meta/', '*/**/build/'].concat(thirdPartyPaths);
      grunt.file.write('.eslintignore', ignorePatterns.join('\n'));
      grunt.file.write('.jshintignore', ignorePatterns.join('\n'));
    };
