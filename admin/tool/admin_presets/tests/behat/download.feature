...
Feature: I can download a preset
  ...
  Scenario: Custom preset settings can be downloaded
    ...
    Then following "Download" in the "Custom preset" "table_row" should download an "xsl" file that:
  ...
  Scenario: Core preset settings can be downloaded
    ...
    Then following "Download" in the "Starter" "table_row" should download an "xsl" file that:
      | Contains | Starter |
