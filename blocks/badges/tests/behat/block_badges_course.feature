...
Feature: Enable Block Badges in a course
  ...
  Background:
    ...
    And the following "core_badges > Badges" exist:
      | name    | course | description | image                                  | type |
      | Badge 1 | C1     | Badge 1     | blocks/badges/tests/fixtures/badge.png | 2    |
      | Badge 2 | C1     | Badge 2     | blocks/badges/tests/fixtures/badge.png | 2    |
