 ...
 * @property {string} exportUrlId The element ID of the Calendar URL text field.
 */
const selectors = {
    copyUrlId: 'copyexporturl',
    exportUrlId: 'calendarexporturl',
};
...
export const init = () => {
    ...
    // Initialise copy to clipboard functionality.
    copyToClipboardEnhance(selectors.copyUrlId, selectors.exportUrlId, {
        messageKey: 'calendarurlcopiedtoclipboard',
        messageComponent: 'calendar'
    });
};
