...
class core_calendar_external extends external_api {
     ...
     * @param   int     $day The month to be shown
     * @param   int     $courseid The course to be included
     * @return  array
     */
    public static function get_calendar_day_view($year, $month, $day, $courseid) {
        ...
        // Parameter validation.
        self::validate_parameters(self::get_calendar_day_view_parameters(), [
            'year' => $year,
            'month' => $month,
            'day' => $day,
            'courseid' => $courseid,
    ...
    public static function get_calendar_day_view_returns() {
        return \core_calendar\external\day_exporter::get_read_structure();
    }
}
