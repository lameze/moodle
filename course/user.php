...
switch ($mode) {
    case "grade":
        ...
        break;
    default:
        // It's unlikely to reach this piece of code, as the mode is never empty and it sets mode as grade in last case.
        // Display the page header to avoid breaking the navigation.
        echo $OUTPUT->header();
}
