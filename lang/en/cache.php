...
$string['cachedef_question_has_capability_on_questions'] = 'Question records for question_has_capability_on';
$string['cachedef_question_has_capability_on_categories'] = 'Question category records for question_has_capability_on';
$string['cachedef_question_has_capability_on_cachedcat'] = 'Question category ids that have had question records pre-fetched for question_has_capability_on';
