 ...
 * @property-read bool $enabledownloadcmcontent True if content download is enabled for this course module, false otherwise.
 */
class cm_info implements IteratorAggregate {
     ...
     */
    private $enabledownloadcmcontent;
    ...
    public function get_course_module_record($additionalfields = false) {
        ...
        static $cmfields = array('id', 'course', 'module', 'instance', 'section', 'idnumber', 'added',
            ...
            'showdescription', 'availability', 'deletioninprogress', 'enabledownloadcmcontent');
    ...
    public function __construct(course_modinfo $modinfo, $notused1, $mod, $notused2) {
        ...
        $this->enabledownloadcmcontent = isset($mod->enabledownloadcmcontent) ? $mod->enabledownloadcmcontent : null;
