...
$string['errorrecordmodifiedforuser'] = 'The grade for {$a} was not saved because it has just been changed by someone else.';
...
$string['quickgradingchangeserror'] = 'The following {$a} grades were not updated:';
$string['quickgradingerrorforuser'] = 'The grade for {$a->fullname} was not updated with value "{$a->grade}".';
