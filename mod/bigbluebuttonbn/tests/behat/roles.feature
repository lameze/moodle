...
Feature: Set role as Bigbluebuttonbn moderator
  ...
  Scenario: Set the manager role as room moderator
    Given I am on the "bigbluebuttonbn1" "bigbluebuttonbn activity editing" page logged in as "admin"
    ...
    When I am on the "bigbluebuttonbn1" "bigbluebuttonbn activity editing" page
