...
/**
 * The post_inline_attachment vault tests.
 *
 * @package    mod_forum
 * @copyright  2021 Simey Lameze <simey@moodle.com>
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_forum_vaults_post_inline_attachment_testcase extends advanced_testcase {
    ...
    public function test_get_inline_attachments_for_posts() {
        ...
        $vault = $vaultfactory->get_post_inline_attachment_vault();
