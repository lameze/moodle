@mod @mod_h5pactivity @core_h5p @core_completion
Feature: Manual completion of H5P activity
  In order to mark an H5P activity as done
  As a student
  ...
  Scenario: Verify that students can manually mark the h5p activity as done
