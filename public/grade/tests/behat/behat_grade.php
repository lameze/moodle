...
class behat_grade extends behat_base {
     ...
     */
    #[\Behat\Step\Given('/^I give the grade "(?P<grade_number>(?:[^"]|\\\\")*)" to the user "(?P<username_string>(?:[^"]|\\\\")*)" for the grade item "(?P<grade_activity_string>(?:[^"]|\\\\")*)"$/')]
     ...
     */
    #[\Behat\Step\Given('/^I set the following settings for grade item "(?P<grade_item_string>(?:[^"]|\\\\")*)" of type "([^"]*)" on "([^"]*)" page:$/')]
     ...
     * @param string $page
     */
    #[\Behat\Step\Given('/^I hide the grade item "(?P<grade_item_string>(?:[^"]|\\\\")*)" of type "([^"]*)" on "([^"]*)" page$/')]
     ...
     * @param string $gradeitem
     */
    #[\Behat\Step\Given('/^I duplicate the grade item "(?P<grade_item_string>(?:[^"]|\\\\")*)"$/')]
     ...
     */
    #[\Behat\Step\Given('/^I set "(?P<calculation_string>(?:[^"]|\\\\")*)" calculation for grade item "(?P<grade_item_string>(?:[^"]|\\\\")*)" with idnumbers:$/')]
     ...
     */
    #[\Behat\Step\Given('/^I set "(?P<calculation_string>(?:[^"]|\\\\")*)" calculation for grade category "(?P<grade_item_string>(?:[^"]|\\\\")*)" with idnumbers:$/')]
     ...
     * @param string $gradeitem
     */
    #[\Behat\Step\Given('/^I reset weights for grade category "(?P<grade_item_string>(?:[^"]|\\\\")*)"$/')]
     ...
     */
    #[\Behat\Step\Given('/^gradebook calculations for the course "(?P<coursename_string>(?:[^"]|\\\\")*)" are frozen at version "(?P<version_string>(?:[^"]|\\\\")*)"$/')]
     ...
     */
    #[\Behat\Step\Given('/^I navigate to "(?P<gradepath_string>(?:[^"]|\\\\")*)" in the course gradebook$/')]
     ...
     */
    #[\Behat\Step\Given('/^I navigate to "(?P<importoption_string>(?:[^"]|\\\\")*)" import page in the course gradebook$/')]
     ...
     */
    #[\Behat\Step\Given('/^I navigate to "(?P<exportoption_string>(?:[^"]|\\\\")*)" export page in the course gradebook$/')]
