...
class behat_groups extends behat_base {
     ...
     */
    #[\Behat\Step\Given('/^I add "(?P<user_fullname_string>(?:[^"]|\\\\")*)" user to "(?P<group_name_string>(?:[^"]|\\\\")*)" group members$/')]
     ...
     */
    #[\Behat\Step\Given('/^the group overview should include groups "(?P<groups_string>(?:[^"]|\\\\")*)" in grouping "(?P<grouping_string>(?:[^"]|\\\\")*)"$/')]
