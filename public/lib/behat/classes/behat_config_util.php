...
class behat_config_util {
    ...
    public function get_config_file_contents($features = '', $contexts = '', $tags = '', $parallelruns = 0, $currentrun = 0) {
        ...
        return $this->get_config_file_php_contents($config);
    }

    /**
     * Convert the config array to the contents of a behat.php config file.
     *
     * Behat is moving from YAML to PHP configuration files: behat.php is
     * supported since Behat 3.31 and YAML support is removed in Behat 4.0.
     *
     * @param array $config the behat config array.
     * @return string PHP code returning a \Behat\Config\Config instance.
     */
    protected function get_config_file_php_contents(array $config): string {
...
//
// This file is auto-generated by Moodle (admin/tool/behat/cli/init.php or
// admin/tool/behat/cli/util.php). Do not edit it manually: use
// \$CFG->behat_config or \$CFG->behat_profile in config.php to customise
// the generated configuration.

return new \\Behat\\Config\\Config({$export});
...
EOF;
    ...
    /**
     * Build config for the behat config file.
     *
    ...
    /**
     * Parse $CFG->behat_profile and return the array with required config structure for the behat config file.
     *
    ...
    /**
     * Parse $CFG->behat_config and return the array with required config structure for the behat config file
     *
     * @param string $profile profile name
     * @param array $values values for profile
     * @return array
