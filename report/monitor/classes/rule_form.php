<?php
/**
 * The mform for creating and editing a trigger
 *
...
class rule_form extends \moodleform {
    ...
    function definition () {
        ...
        $eventoption = \report_monitor\eventlist::get_events_list();
        $pluginslist = \report_monitor\eventlist::get_plugin_list();
    ...
    function validation($data, $files) {
        ...
        $event = \report_monitor\eventlist::get_all_events_list(false, $data['plugin']);

        if(!array_key_exists($data['event'], $event)) {
            $errors['event'] = get_string('errorevent', 'report_monitor');
