...
if ($hassiteconfig) {
    ...
    $temp = new admin_externalpage('reprotmonitorsubscriptions', get_string('managesubscriptions', 'report_monitor'), $url,
    ...
    $temp = new admin_externalpage('reprotmonitorrules', get_string('managerules', 'report_monitor'), $url,
